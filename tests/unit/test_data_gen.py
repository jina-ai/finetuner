...
from ..data_generator import fashion_doc_generator, fashion_match_doc_generator, fashion_match_documentarray
...
def test_fashion_matches_generator(num_pos, num_neg, pos_value, neg_value):
    for d in fashion_match_doc_generator(num_pos, num_neg, pos_value=pos_value, neg_value=neg_value):
