...
if __name__ == '__main__':
    ...
    from my_executors import MyIndexer, MyEvaluator, MyConverter
    from paddle_executors import MyPaddleEncoder
else:
    from .helper import (
        print_result,
        write_html,
...
def hello_world(args):
    ...
    f = (
        Flow()
        .add(uses=MyPaddleEncoder, uses_with={'model_path': './checkpoints/epoch_9.pd'}, parallel=2)
