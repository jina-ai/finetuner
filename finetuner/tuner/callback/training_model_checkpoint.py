...
class TrainingModelCheckpoint(BaseCallback):
    """
    ...
    def __init__(
        ...
        :param monitor: if `monitor='loss'` model saved will be according
            to the training loss, if `monitor='val_loss'` model saved will be
            according to the validation loss
        :param mode: one of {'auto', 'min', 'max'}. This is for
